...
ICON_WELCOME  = "yoto:#CfeVWoQtDUMnxmlOJ8_0TfqlkFsjDtGZZrsVb5A08RI"  # Happy
ICON_QUESTION = "yoto:#gTMbacpoeSMYqc9fNLJnxPjylraNG6jIrYEWevyzYbA"  # Book
ICON_TRUE     = "yoto:#tNXOIzQIPO6OjSzmT5WFofHhK3-KRGYvnlBxE1oF0-4"  # Celebrate
ICON_FALSE    = "yoto:#zSSkg9JHZwR7FyUnNBFieSk1zhybbzTPJAR3Am8RHVU"  # Robot
        ...
        "content": {
            "chapters": [
                ...
                },
                {
                    ...
                    "tracks": [
                        stream_track("01", "Question", "question", "?", ICON_QUESTION),
                        stream_track("02", "True",     "true",     "T", ICON_TRUE),
                        stream_track("03", "False",    "false",    "F", ICON_FALSE),
                    ],
                },
                {
                    "key":   "03",
